...
struct TQueryOptions {
  ...
  34: optional string runtime_filter_mode = "GLOBAL";
  ...
  35: optional i32 runtime_bloom_filter_size = 1048576

  // Minimum runtime bloom filter size, in bytes
  36: optional i32 runtime_bloom_filter_min_size = 1048576

  // Maximum runtime bloom filter size, in bytes
  37: optional i32 runtime_bloom_filter_max_size = 16777216

  // Time in ms to wait until runtime filters are delivered.
  38: optional i32 runtime_filter_wait_time_ms = 1000

  // Maximum number of bloom runtime filters allowed per query
  39: optional i32 runtime_filters_max_num = 10

  // Runtime filter type used, For testing, Corresponds to TRuntimeFilterType
  40: optional i32 runtime_filter_type = 1;

  41: optional i32 runtime_filter_max_in_num = 1024;
}
