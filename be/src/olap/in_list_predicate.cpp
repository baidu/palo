...
#define IN_LIST_PRED_CONSTRUCTOR_DECLARATION(CLASS)                                                        \
    template CLASS<int8_t>::CLASS(uint32_t column_id, std::unordered_set<int8_t>&& values, bool opposite);           \
    template CLASS<int16_t>::CLASS(uint32_t column_id, std::unordered_set<int16_t>&& values, bool opposite);         \
    template CLASS<int32_t>::CLASS(uint32_t column_id, std::unordered_set<int32_t>&& values, bool opposite);         \
    template CLASS<int64_t>::CLASS(uint32_t column_id, std::unordered_set<int64_t>&& values, bool opposite);         \
    template CLASS<int128_t>::CLASS(uint32_t column_id, std::unordered_set<int128_t>&& values, bool opposite);       \
    template CLASS<float>::CLASS(uint32_t column_id, std::unordered_set<float>&& values, bool opposite);             \
    template CLASS<double>::CLASS(uint32_t column_id, std::unordered_set<double>&& values, bool opposite);           \
    template CLASS<decimal12_t>::CLASS(uint32_t column_id, std::unordered_set<decimal12_t>&& values, bool opposite); \
    template CLASS<StringValue>::CLASS(uint32_t column_id, std::unordered_set<StringValue>&& values, bool opposite); \
    template CLASS<uint24_t>::CLASS(uint32_t column_id, std::unordered_set<uint24_t>&& values, bool opposite);       \
    template CLASS<uint64_t>::CLASS(uint32_t column_id, std::unordered_set<uint64_t>&& values, bool opposite);
