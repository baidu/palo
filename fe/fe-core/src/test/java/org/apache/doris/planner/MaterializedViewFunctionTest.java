...
public class MaterializedViewFunctionTest {
    ...
    public void afterMethod() throws Exception {
        dorisAssert.dropTableForce(EMPS_TABLE_NAME);
        dorisAssert.dropTableForce(DEPTS_TABLE_NAME);
        dorisAssert.dropTableForce(USER_TAG_TABLE_NAME);
    }
    ...
    */
    ...
    public void testAggFunctionInHaving() throws Exception {
        ...
        dorisAssert.dropTableForce(TEST_TABLE_NAME);
    }
    ...
    public void testCreateMVBaseBitmapAggTable() throws Exception {
        ...
        dorisAssert.dropTableForce("agg_table");
    }
}
