...
public class DataDescriptionTest {
    ...
    public void testNormal() throws AnalysisException {
        ...
        desc = new DataDescription("testTable", null, Lists.newArrayList("abc.txt"),
                Lists.newArrayList("col1", "col2"), new Separator(","), "csv", null, false, null, whereExpr, LoadTask.MergeType.MERGE, whereExpr, null);
        desc.analyze("testDb");
    ...
    public void testNegMerge() throws AnalysisException {
        ...
        DataDescription desc = new DataDescription("testTable", null, Lists.newArrayList("abc.txt"),
                Lists.newArrayList("col1", "col2"), new Separator(","), "csv", null, true, null, whereExpr, LoadTask.MergeType.MERGE, whereExpr, null);
        desc.analyze("testDb");
    }
